            ...
            <section id="about">
                <div className="about container">
                    ...
                    <div className="about-item">
                        <div className="icon"><img src="https://ca.slack-edge.com/T01CJB8EK7C-U01CX0C29Q9-e22a97dd0a56-512" className="about-img" alt=""/></div>
                    ...
                    <div className="about-item">
                        <div className="icon"><img src="https://ca.slack-edge.com/T01CJB8EK7C-U01CG6CKJQ5-589ddb09214d-512" className="about-img" alt=""/></div>
                        <div className="about-info">
